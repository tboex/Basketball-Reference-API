...
def get_players():
    file = None
    try:
        filename = "saved/localcache/players_" + str(datetime.datetime.now().date()) +".txt"
...
def get_teams():
    try:
        filename = "saved/localcache/teams_" + str(datetime.datetime.now().date()) +".txt"
        file = open(filename, "r")
        for line in file.readlines():
...
def write_to_file(data, type):
    ...
    filename = "saved/localcache/" + type + "_" + str(datetime.datetime.now().date()) + ".txt"
